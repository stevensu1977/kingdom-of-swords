...
- Git includes the reviewed source, original props/audio, attributed archer,
  ...
  and two stills from that recording: `docs/media/cover.png` at 00:10 and
  `docs/media/menu.png` at 00:01.
...
- The selected recording shows the original artwork and local music; the
  screenshots show the same artwork. Their inclusion does not change the underlying
